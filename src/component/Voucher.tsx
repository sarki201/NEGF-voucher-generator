    ...
    <div className="min-h-screen bg-gray-100 p-8 flex flex-col items-center">
      <div className="bg-white shadow-lg rounded-lg w-full max-w-2xl">
        <form
          ...
          className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-4 p-6 border-b border-solid border-black pb-4"
        >
          <div>
          ...
          <button className="cursor-pointer bg-green-400 hover:bg-green-700 transition-all duration-300 text-white rounded-sm py-2">
            Submit
          </button>
        </form>
        <div className="absolute left-[-9999px] w-[672px] p-6">
          <div ref={printRef} className="p-8 bg-white">
            <div className="flex items-start gap-10">
              <img src="/logo.jpg" alt="logo" className="w-22 h-22" />
              <div className="text-center">
                <h1 className="text-lg font-bold">
                  NORTHEAST GOVERNORS' FORUM (NEGF)
                </h1>
                <h3 className="text-base">No. 3 Shehu Laminu Way, Old GRA</h3>
                <h3 className="text-base">Maiduguri, Borno State</h3>
              </div>
            </div>
            <div className="text-start">
              <p className="text-xs ml-20 mb-1">NEGF</p>
              <h5 className="text-center text-sm mb-2">PAYMENT VOUCHER</h5>
              <div className="grid grid-cols-7 ml-10 mr-4">
                <div className="col-span-5 pt-4">
                  ...
                  <div className="grid grid-cols-20 border-b border-solid border-black">
                    ...
                    <div className="col-span-12 text-[10px] font-bold pl-1 pb-2 border-t border-b border-r border-solid border-black">
                      Detailed description fo services or goods
                    </div>
                  ...
                  <p className="text-[8px] font-bold mb-2">
                    Certified that the details above are in accordance with the
                    relevant contract, regulations or other authority under
                    which the Services / Good were provided/ purchased
                  </p>
                  ...
                  <p className="text-[9px] mb-1">
                    ...
                    performed/received, that the financial authority is held to
                    incur this expenditure and that the relevant D.V.E Account
                  ...
                  <p className="text-[9px] mb-1">
                    ...
                    _________ kobo in payment of the above account this _______
                    day of _________ 20 ___
                  </p>
                ...
                <div className="col-span-2">
                  ...
                  <div className="border-t border-l border-solid border-black">
                    ...
                    <div className="pl-2 border-b border-t border-solid border-black mb-1">
                      <p className="text-[8px] mb-1">PV No.</p>
